...
public class BitcoinSVPaymentSupport extends AbstractRPCPaymentSupport {
    private static final Logger log = LoggerFactory.getLogger(BitcoinSVPaymentSupport.class);

    private BitcoinSVAddressValidator addressValidator = new BitcoinSVAddressValidator();
...
//
//        BitcoinSVRPCWallet wallet = new BitcoinSVRPCWallet("http://rpcuser:rpcpassword@localhost:8332", "");
//        BitcoinSVPaymentSupport ps = new BitcoinSVPaymentSupport();
//        ps.init(null);
//        PRS spec = new PRS(
//            ps.getCurrency(),
//            "Just a test",
...
//    }
    ...
    @Override
    public String getSigHashType() {//This is BitcoinSV specific. No need to override this method for other currencies
        return "ALL|FORKID";
    }
