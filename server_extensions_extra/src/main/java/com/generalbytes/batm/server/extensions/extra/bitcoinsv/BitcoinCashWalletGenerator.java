...
public class BitcoinSVWalletGenerator implements IPaperWalletGenerator {

    private static final Logger log = LoggerFactory.getLogger("batm.master.BitcoinWalletGenerator");
    private String prefix;
    private IExtensionContext ctx;

    public BitcoinSVWalletGenerator(String prefix, IExtensionContext ctx) {
        this.prefix = prefix;
        this.ctx = ctx;
    }
    ...
    public IPaperWallet generateWallet(String cryptoCurrency, String oneTimePassword, String userLanguage) {
        ...
        return new BitcoinSVPaperWallet(cryptoCurrency, content, address, privateKey, messageText,"application/zip", "zip");
    }
